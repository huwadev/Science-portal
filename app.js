...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        [LANG_EN]: {
            ...
            future_tag: "Pipeline",
            future_title: "Future Initiatives",
            future_subtitle: "Upcoming scientific tools and portals currently in development by ESSS.",
        ...
        [LANG_AM]: {
            ...
            future_tag: "የወደፊት ዕቅዶች",
            future_title: "የወደፊት ተግባራት",
            future_subtitle: "በኢትዮጵያ ስፔስ ሳይንስ ሶሳይቲ በመገንባት ላይ ያሉ አዳዲስ ሳይንሳዊ መተግበሪያዎች።",
